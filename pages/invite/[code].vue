...
<template>
      ...
      <div class="max-w-md w-full px-4">
        ...
        <div v-if="loadingInvite" class="flex flex-col items-center py-12">
          <div class="flex justify-center mb-8">
            <img src="/logo-v2-240.webp" alt="Ninja Tab logo" class="w-28" />
          </div>
  ...
  >
    <div class="flex items-center gap-3 px-4 py-3 max-w-2xl mx-auto">
      <img src="/logo-v2-240.webp" alt="Ninja Tab logo" class="w-9 h-9 shrink-0 rounded-[5px]" style="background-color: #101828" />
      <div class="flex-1 min-w-0">
        <p class="text-black text-sm font-semibold leading-tight">Ninja Tab</p>
